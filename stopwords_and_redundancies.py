...
Description
===============================
This module is dedicated to our customized stopwords set and location redundancies set,
which are called upon in the computing_data functions during the filtering process.
...
LOCATION_REDUNDANCIES = {'north', 'lake', 'southern', 'area', 'united', 'south',
                         'region', 'city', 'land', 'coast', 'country', 'west', 'east', 'county', 'springs'
                                                                                                 'valley', 'beach',
                         'greater', 'view', 'stone', 'fort', 'central', 'cape', 'national',
                         'long', 'white', 'free', 'western'}
